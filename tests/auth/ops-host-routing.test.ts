...
describe("OPS-07 explicit host/path route matrix", () => {
  const cases = [
    ...
    ["ops console", "/ops", "ops.example.test", "next", null],
    ["ops console child", "/ops/review", "ops.example.test", "next", null],
    ...
    ["ops marketplace page", "/spaces", "ops.example.test", "rewrite", "/_ops-cloak"],
    ["ops direct internal auth", "/_ops-auth/login", "ops.example.test", "rewrite", "/_ops-cloak"],
    ["public ops root", "/ops", "app.example.test", "rewrite", "/_ops-cloak"],
    ["public ops child", "/ops/review", "app.example.test", "rewrite", "/_ops-cloak"],
    ["public adjacent path", "/opsfoo", "app.example.test", "next", null],
    ["public direct internal auth", "/_ops-auth/login", "app.example.test", "rewrite", "/_ops-cloak"],
    ...
    ["preview ops root", "/ops", PREVIEW_HOST, "rewrite", "/_ops-cloak"],
    ["unknown marketplace login", "/login", "random.example.test", "next", null],
    ["unknown ops root", "/ops", "random.example.test", "rewrite", "/_ops-cloak"],
    ["missing Host ops root", "/ops", null, "rewrite", "/_ops-cloak"],
  ] as const;
