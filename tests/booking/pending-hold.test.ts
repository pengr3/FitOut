...
// A fixed future window. createPendingHold works on absolute UTC instants, so the venue tz is irrelevant
// to the transaction logic (window/operating-hours validity is re-derived at the action layer, next plan).
