...
- **Phase 18.1 · 5 · 1 complete, 4 planned** — written at plan time per D-239 by `18.1-01`. HVER-08 was moved to Complete by `18.1-11`, the last of its five named plans. Phase 18's roadmap checkbox cannot be ticked until these land; the executor of each plan named above moves its row to Complete.
