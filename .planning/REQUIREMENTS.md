...
- **Phase 18.1 · 5 · 2 complete, 3 planned** — written at plan time per D-239 by `18.1-01`. HVER-08 was moved to Complete by `18.1-11`, the last of its five named plans; LVER-05 by `18.1-12`, its only one. HVER-06 and HVER-07 both still name `18.1-14`'s hand-walk as their outstanding proof, and OPS-06 is `18.1-13`. Phase 18's roadmap checkbox cannot be ticked until these land; the executor of each plan named above moves its row to Complete.
