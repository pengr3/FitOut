...
---
*Last updated: 2026-07-14 — after Phase 3 (Availability & the Double-Booking Guarantee) completion: AVAIL-01..05 validated; the DB-level GiST `EXCLUDE` double-booking guarantee (D-21 units model) shipped and verified (12/12 must-haves). Prior update: 2026-07-11 — at Phase 3 planning transition: **D-21 (units occupancy model)** recorded in Key Decisions (reshapes Phases 4 & 8).*
