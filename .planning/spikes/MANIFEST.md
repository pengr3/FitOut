...
| 009 | progressive-search-flow | progressive-journey-stress | standard | Verify the chosen search-pill journey survives Back, edit, cancel, result handoff, and phone width | ○ **PENDING HUMAN REVIEW** | phase-24, search, ux, responsive, state-machine |
