...
- [x] 20-12-PLAN.md — Add origin-bound ops sign-in, safe callbacks, and same-host recovery/reset UI.

**Wave 8** *(blocked on Wave 7 completion)*

- [x] 20-06-PLAN.md — Expose protected invitation actions and the scanner-safe recipient setup route.
...
- [x] 21-02-PLAN.md — Deliver bounded, private, deterministic listing review history.
...
- [x] 21-07-PLAN.md — Keep rejected payout-onboarding promises inline and retryable.
